...
const testimonials = [
  {
    ...
    initial: "MA",
    testimonial:
      "A Casa YME tratou nossa família com discrição e entregou oportunidades que não estavam disponíveis publicamente. O nível de diligência e a capacidade de negociação impressionam.",
  },
  {
